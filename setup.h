...
/*
  yOpt.SetGain(0.0, 0.0, 0.012, 0.05 ,0.0);
  yOpt.SetLimit(6500, 1000, 10000);
    
  xOpt.SetGain(0.0, 0.0, 0.012, 0.05 ,0.0);
  xOpt.SetLimit(6500, 1000, 10000);

  xMulti.SetGain(0.0, 0.0, 1.6 , 0.4 ,125.0);
  xMulti.SetLimit(4500, 1000, 6000);
    
  yMulti.SetGain(0.0, 0.0, 1.6 , 0.4 ,125.0);
  yMulti.SetLimit(4500, 1000, 6000);

  xMultiM.SetGain(0.0, 0.0, 1.6 , 0.4 ,125.0);
  xMultiM.SetLimit(4500, 1000, 6000);
    
  yMultiM.SetGain(0.0, 0.0, 1.6 , 0.4 ,125.0);
  yMultiM.SetLimit(4500, 1000, 6000);
